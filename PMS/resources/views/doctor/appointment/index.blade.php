...
<div class="container-fluid">
    ...
    <ol class="breadcrumb">
      ...
      <li class="active">
        <i class="material-icons">library_books</i>View Appointment's
      </li>
    </ol>
        </div>
        <div class="header">
                                    ...
                                    @foreach($appointment as $key=>$appointment)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form id="delete-form-{{ $appointment->id }}" action="{{ route('doctor.appointment.destroy',$appointment->id) }}" method="POST" style="display: none;">
                                                    @csrf
                                                    @method('DELETE')
                                                </form>
                                            </td>
